 ...
 */
URL releasesUrl = new URL("file:///Users/cleclerc/git/jenkins/backend-crawler/target/cloudfoundry-cli-releases.json") //new URL("https://api.github.com/repos/cloudfoundry/cli/releases")
